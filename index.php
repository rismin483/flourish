...
<body class="preload push_filter_left" style="background: #ffffff;">
  ...
  <div class="collapse navbar-collapse">
    <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
            <a href="#about" title="About Us" class="delay03  relative nav-link menu_lv1 ">About Us</a>
        </li>
        <li class="nav-item dropdown">
            <a href="#contact" title="Contact Us" class="delay03 relative  nav-link menu_lv1 ">Contact Us</a>
        </li>
    </ul>
  </div>
</nav>
...
</div><div id="shopify-section-1580441602710" class="shopify-section"><div data-section-id="1580441602710" data-section-type="section-banner-v4" style=" ">
    ...
    <div class="container container-v2">
      <div class="row">
        <div class="col-lg-6 col-md-6 col-12 col-sm-12">
          <div class="box-info">
            <div class="box-img-one box-img" >
              <img src="cdn.shopify.com/s/files/1/0317/0687/3992/files/banner-v4-2f12f.jpg?v=1580454437" class="img-fluid">
            </div>

            <div class="content-banner">
                <p class="sub_title" style="color: ">New Collection</p>
                <h3 class="title mb-0" style="color : ">Plant Port</h3>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-12 col-sm-12">
          <div class="box-info">
            <div class="box-img-one box-img">
                <img src="cdn.shopify.com/s/files/1/0317/0687/3992/files/banner-v4-1f0a0.jpg?v=1580454429" class="img-fluid">
            </div>
              <div class="content-banner">
                  <p class="sub_title" style="color: ">Only On Our Store!</p>
                  <h3 class="title mb-0" style="color : ">Ceramic Pot & Plant</h3>
              </div>
...
</div><div id="shopify-section-1580442916056" class="shopify-section"><div data-section-id="1580442916056" data-section-type="section-blog-v2" style="  ">
  <div class="section-blog-v4">
    <div class="container container-v2" id="about">
      ...
      <div class="blog-content row">
        ...
        <div class="blog-item col-lg-12 left">
          <div class="row align-items-center justify-content-center">
            <div class="post col-12 col-md-6 order-2 order-sm-2 order-md-1 order-lg-1">
              <h4 class="article-title">
                <a href="#" class="d-block">Plants help make your house more beautiful</a>
              </h4>
              
              <p class="article-des">Flourish helps you to find better plants and decor for your home, office, garden, lawns etc.</p>
              
            </div>

            <div class="col-12 image col-md-6 order-1 order-lg-2">
              <a href="#" class="d-block">
                <img src="cdn.shopify.com/s/files/1/0317/0687/3992/articles/blog12_1024x102485fa.jpg?v=1580379124" alt="Plants help make your house more beautiful" class="img-fluid w-100">
              </a>
            </div>
          </div>
        </div>
