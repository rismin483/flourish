                    ...
                    <div class="content-page contact-page">
                        ...
                        <div class="container" style="margin-top: 70px;">
                            <div class="contact-form">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h3><strong>Add Plants</strong></h3>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-6">
                                        <br><div class="contact-form-page">
                                                <div class="contact-form">
                                                    <p class="contact-name">
                                                        <input class="" placeholder="Plant Name *" type="text" id="plantName" name="plantName" required>
                                                    </p>
                                                    <p class="contact-subject">
                                                        <input class="" placeholder="Plant Count *" type="text" id="plantCount" name="plantCount" required>
                                                    </p>
                                                    <p class="contact-subject">
                                                        <select class="form-control" id="plantCategory" name="plantCategory" required>
                                                          <option value="">Select Category</option>
                                                          <?php
                                                            $getCategory = $con->query("select * from addcategory");
                                                            while($CategoryArray = $getCategory->fetch_array())
                                                            {
                                                    ...
                                                    <p class="contact-submit">
                                                        <input  class="shop-button" type="submit" name="addPlant" value="Add">
                                                    </p>
                                                </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-12">
                                        <br><div class="contact-form-page">
                                                <div class="contact-form">
                                                    <p class="contact-name">
                                                        <input class="" placeholder="Botanical Name *" type="text" id="botanicalName" name="botanicalName" required>
                                                    </p>
                                                    <p class="contact-email">
                                                        <input class="" placeholder="Plant Price *" type="text" id="plantPrice" name="plantPrice" required>
                                                    </p>
                                                    <p class="contact-message">
                                                        <textarea class="" placeholder="Description *" cols="30" rows="4" id="plantDescription" name="plantDescription" required></textarea>
                                                    </p>
                                                </div>
                                        </div>
                                    </div>
        ...
        <div class="col-lg-2 col-md-3">
          <div class="info_footer">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li><a href="#">rismin10@gmail.com</a></li>
...
if (isset($_POST['addPlant']))
{
    ...
    $addPlant = $con->query("insert into addplants(plantname,botname,category,plantprice,plantcount,description) values ('$plantName','$botanicalName','$plantCategory','$plantPrice','$plantCount','$plantDescription')");
    if($addPlant)
    {
			echo "<script>alert('Plants added successfully...')</script>";
