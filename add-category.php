                                        ...
                                        <br><div class="contact-form-page">
                                                <div class="contact-form">
                                                    <p class="contact-name">
                                                        <input class="" placeholder="Category Name *" type="text" id="categoryName" name="categoryName" required>
                                                    </p>
                                                    <p class="contact-submit">
                                                        <input  class="shop-button" type="submit" name="addCategory" value="Add">
                                                    </p>
                                                </div>
                                        </div>
                                    </div>
...
if (isset($_POST['addCategory']))
{
    ...
    $addCategory = $con->query("insert into addcategory(catname) values ('$categoryName')");
    if($addCategory)
    {
