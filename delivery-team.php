          ...
          <div class="itemv-slide-h1">
              <div class="  info-sideh1-no-effect ">
                  <div class="picture-slideshow">
                      <h3 style="margin-top: 120px;margin-left: 150px;">View Delivery Team</h3>
                      <a href="add-delivery-team.php"><button class="btn btn-primary" style="float: right; margin-right: 200px; margin-bottom: 10px;">Add New</button></a>
                      <div style="text-align: center">
                          <div class="col-lg-9" style="margin-top: 40px;margin-left: 150px;">
                              <table class="table--responsive table">
                                  ...
                                  <?php
                                  $getDeliveryTeam = $con->query("select * from adddelteam");
                                  while($getDeliveryArray = $getDeliveryTeam->fetch_array())
                                  {
                                      echo "<tr>";
                                      echo "<td>$getDeliveryArray[1]</td>";
                                      echo "<td>$getDeliveryArray[2]</td>";
                                      echo "<td>$getDeliveryArray[3]</td>";
                                      echo "<td>$getDeliveryArray[4]</td>";
                                      echo "<td>$getDeliveryArray[5]</td>";
                                      echo "<td>$getDeliveryArray[6]</td>";
                                      echo "<td>$getDeliveryArray[7]</td>";
                                      echo "<td>$getDeliveryArray[8]</td>";
                                      echo "<td><a href='edit-delivery-team.php?del_id=$getDeliveryArray[0]'>Update</a></td>";
                                  }
                                  ?>
                              </table>
                          </div>
